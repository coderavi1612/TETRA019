...
class PromptBuilder:
    ...
    def build(
        ...
        output_rules = (
            ...
            "10. If information does not explicitly exist in the chunk, leave the 'value' field as null (e.g. \"value\": null).\n"
            "11. Never invent data.\n"
            "12. Never remove, rename, or delete any keys or sections from the template.\n"
            "13. Fill ONLY the values inside the template. The template's keys and hierarchy must be preserved exactly.\n"
            ...
            "18. Output ONLY valid JSON. No markdown code fences (like ```json), no extra text. Just raw JSON."
        )
        ...
        prompt = (
            ...
            f"EMPTY JSON TEMPLATE (Fill only value, source_reference, source_block_id, page, slide, sheet, extracted_text_snippet keys):\n"
            f"{template_json_str}\n\n"
